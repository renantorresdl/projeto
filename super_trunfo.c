...
int main() {
    ...
    float area1, pib1, densidadepopulacao1, pibcapital1;

    char estado2[20], cidade2[30], codigo2[10];
    int habitantes2, turistico2;
    float area2, pib2, densidadepopulacao2, pibcapital2;
